...
const NavbarLoggedIn = ({ userName }) => {
  ...
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
          ...
          <div className="md:hidden flex items-center z-50">
            <button
              ...
              className="relative w-8 h-7 flex flex-col justify-between items-center focus:outline-none z-50"
            >
              <span
      ...
      >
        <nav className="flex flex-col items-center pt-28 gap-6 font-medium text-gray-900 text-base">
          {navItems.map((item, i) => (
            <Link
              key={item.name}
              to={item.path}
